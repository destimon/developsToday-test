import { PostActionTypes, GET_POSTS, SET_POSTS_LOADING, ADD_POST, ADD_POST_SUCCESS, ADD_POST_FAILURE, SET_ADD_POST_LOADING, CLEAR_ADD_POST_RESULT, GET_POSTS_SUCCESS, GET_POSTS_FAILURE } from "../types"
